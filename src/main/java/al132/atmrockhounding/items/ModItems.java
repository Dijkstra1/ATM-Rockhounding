...
public class ModItems {
	...
	public static ItemBase energized_fuel_blend;
	...
	public static void init(){
		...
		energized_fuel_blend = new ItemBase("energizedFuelBlend");

		
		alloyDusts = new ItemMetaBase("dust", Utils.concatStringArrays(EnumAlloy.getOreArray("dust"),EnumAlloy2.getOreArray("dust")));
		alloyIngots = new ItemMetaBase("ingot", Utils.concatStringArrays(EnumAlloy.getOreArray("ingot"),EnumAlloy2.getOreArray("ingot")));
		alloyNuggets = new ItemMetaBase("nugget", Utils.concatStringArrays(EnumAlloy.getOreArray("nugget"),EnumAlloy2.getOreArray("nugget")));
	...
	public static void initClient(){
		...
		EnumSet.allOf(EnumAlloy2.class).stream().forEach(x -> {
			ModItems.registerMetaExperimental(alloyDusts,x.ordinal()+16,EnumAlloy2.getDictName("", x.ordinal()));
			ModItems.registerMetaExperimental(alloyIngots,x.ordinal()+16,EnumAlloy2.getDictName("", x.ordinal()));
			ModItems.registerMetaExperimental(alloyNuggets,x.ordinal()+16,EnumAlloy2.getDictName("", x.ordinal()));
		});
		...
		energized_fuel_blend.initModel();
