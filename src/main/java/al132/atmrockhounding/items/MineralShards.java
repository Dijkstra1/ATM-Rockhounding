...
public class MineralShards extends ItemMetaBase {

	public MineralShards(String name, String[] array) {
		super(name,array);
	}

	public String formattedString(String name, int amount){
		return formattedString(name,amount,false);
	}

	public String formattedString(String name, int amount, boolean heading){
		if(heading) return TextFormatting.DARK_GRAY + name + TextFormatting.YELLOW;
		else return TextFormatting.DARK_GRAY + name + TextFormatting.WHITE + amount + "%";
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void addInformation(ItemStack itemstack, EntityPlayer player, List<String> list, boolean held) {
